...
WebUI.setText(findTestObject('Object Repository/Page_SecondHand/input_Nama_username'), 'John Smith')

WebUI.setText(findTestObject('Object Repository/Page_SecondHand/input_Email_useremail'), 'john.smithgmail.com')
