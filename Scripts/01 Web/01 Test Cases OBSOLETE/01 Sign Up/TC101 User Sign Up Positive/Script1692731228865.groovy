...
def full_name = GlobalVariable.FullName

Date date = new Date()

String time = date.format('yyyyMMddHHmmss')

def email_address = ('QAE10_GR03_' + time) + '@binar.com'

// GlobalVariable.BuyerEmail = email_address
...
WebUI.setText(findTestObject('Object Repository/Page_SecondHand/input_Nama_username'), full_name)
